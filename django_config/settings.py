...
# a remplacer l'étoile par le nom de domaine
ALLOWED_HOSTS = ["*"]
...
EXTENSION_APPS = ["django_bootstrap5", "phonenumber_field"]

INSTALLED_APPS = INTERNAL_APPS + CREATED_APPS + EXTENSION_APPS
...
# va chercher l'url de la database dans .env
...
AUTH_USER_MODEL = "epic_events.Collaborator"
